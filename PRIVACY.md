...
AlterSendme is designed with privacy and security as core principles. This privacy policy explains how the application handles your data and what information may be visible to third parties.

## Core Privacy Principles

- **No Account Required**: AlterSendme does not require user registration, accounts, or any personal information
...
## How AlterSendme Works

AlterSendme uses peer-to-peer (P2P) networking technology powered by [Iroh](https://www.iroh.computer) to transfer files directly between devices. The application:
...
AlterSendme stores the following data locally on your device:
...
By default, AlterSendme may use relay servers operated by the [Iroh project](https://www.iroh.computer) (n0) when direct peer-to-peer connections cannot be established. 
...
When using Node ID-only tickets, AlterSendme may use DNS-based discovery services (Pkarr) to find peer addresses. This service may temporarily store:
...
AlterSendme is open source software licensed under AGPL-3.0. You can:
- Review the complete source code on [GitHub](https://github.com/bruceblink/alter-sendme)
...
AlterSendme uses the following third-party services:
...
This privacy policy may be updated from time to time. The "Last Updated" date at the top indicates when changes were made. Continued use of AlterSendme after changes constitutes acceptance of the updated policy.

## Contact

If you have questions about this privacy policy or how AlterSendme handles your data, please open an issue on [GitHub](https://github.com/bruceblink/alter-sendme/issues).

## Disclaimer

While AlterSendme is designed with privacy and security in mind, no method of transmission over the internet is 100% secure. Users should:
